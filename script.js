...
form.addEventListener("submit", (e) => validateFormValues());

// This doesn't work
const checkedCheckBox = document.querySelector("delete-checkbox");
if (checkedCheckBox) {
...
const addCommasToDollars = (x) => x.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
